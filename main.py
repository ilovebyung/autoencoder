...
def spectrogram_loss(autoencoder, spectrogram, size=224):
    ...
    spectrogram_loss = np.mean(loss) + np.std(loss)
...
if __name__ == "__main__":
    ...
    # set baseline statistics as threshold
    ...
    spectrogram = pathlib.Path('c:/data/img.jpg')
    spectrogram = 'c:/data/img.jpg'
    spectrogram_loss = spectrogram_loss(autoencoder, spectrogram)

    if spectrogram_loss > threshold:
        print(f'{spectrogram}:{spectrogram_loss} exceeds threshold')
